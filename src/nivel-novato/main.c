...
int main(){
    ...
    printf("PIB: %.2f bilhoes de reais\n", pib1 / 1e9);    // Mostra o PIB com 2 casas decimais e divide os bilhoes para melhor visibilidade.
    ...
    printf("PIB: %.2f bilhoes de reais\n", pib2 / 1e9); // Mostra o PIB com 2 casas decimais e divide os bilhoes para melhor visibilidade.
    printf("Numero de Pontos Turisticos: %d\n", pontosTuristicos2);
